...
export const usePurchaseOrderOptions = ({
  ...
  const handlePDFGeneration = async () => {
    try {
        ...
        pdf.save(`Purchase_Order_N${formExtract?.num}.pdf`);
    } catch (error) {
