...
export const Hero = () => {
  return (
    <div className="relative bg-cover bg-center flex lg:h-screen">
      <div className="relative isolate lg: w-full">
        <div className="h-full grid grid-cols-1 lg:grid-cols-2 gap-8 ">
          <div className="flex flex-col py-20 px-12 sm:py-12 justify-center">
            <div className="justify-center mb-8 flex">
              <div className="flex rounded-full px-3 py-1 text-sm leading-6 text-gray-400 ring-1 ring-gray-900/10 hover:ring-gray-900/20 xl:text-lg">
            ...
            <div className="text-center lg:text-left">
              <h1 className="max-sm:text-xl text-4xl text-center font-bold tracking-tight text-indigo-600 xl:text-6xl">
                Aplicación de Automatización de los Servicios en la Empresa Automotriz ServiAutos Baez
              </h1>
              <p className="max-sm:text-sm mt-6 text-lg leading-8 text-gray-200 text-justify xl:text-2xl">
              ...
              <div className="relative h-64 w-full mt-8 lg:hidden">
                <Image
                  src="/images/hero.png"
