    ...
    <div className="relative h-screen w-screen -mt-[65px]">
      ...
      >
        ...
        <SwiperSlide className="relative h-screen flex justify-center items-center">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
              Automatiza los Servicios del Taller
            </h1>
            <p className="max-w-2xl text-lg md:text-xl text-white mb-8">
              Gestiona facturas, presupuestos e inventario de manera eficiente para llevar el negocio al siguiente nivel.
            </p>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide className="relative h-screen flex justify-center items-center">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
              Optimiza la Gestión del Taller
            </h1>
            <p className="max-w-2xl text-lg md:text-xl text-white mb-8">
              Controla todos los procesos desde un solo lugar, mejorando la eficiencia y productividad.
            </p>
          </div>
        </SwiperSlide>
      </Swiper>
